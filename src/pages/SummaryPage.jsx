...
export default function SummaryPage() {
  ...
  async function loadSummary() {
    ...
    try {
      ...
      // Build query — managers see all store, cashiers see own sales
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <TopBar
        ...
        subtitle={`Today · ${new Date().toLocaleDateString('en-US', { dateStyle: 'medium' })}`}
        showBack
        backTo="/pos"
      />
      ...
      <div className="flex-1 p-4 max-w-2xl mx-auto w-full space-y-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-2xl border border-gray-200 p-4">
            ...
            <p className="text-base font-bold text-gray-900 leading-tight">
              {formatMMK(stats?.totalRevenue || 0)}
            </p>
          </div>
          <div className="bg-white rounded-2xl border border-gray-200 p-4">
            <div className="flex items-center gap-2 mb-2">
                ...
                <div key={txn.id} className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex-1">
                    <p className="text-xs font-medium text-gray-800">
                      {new Date(txn.completed_at).toLocaleTimeString('en-US', {
                        timeStyle: 'short'
                      })}
                    </p>
        ...
        {stats?.txnCount === 0 && (
          <div className="bg-white rounded-2xl border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-400 text-xs mt-1">Start selling to see your summary</p>
          </div>
        )}
